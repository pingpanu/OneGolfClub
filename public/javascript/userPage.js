                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr class="fwy"> <td>Fairways</td>
                                ...
                                <td colspan="2"></td> </tr>
                            <!-- Green in Regulation -->
                            <tr class="gir"> <td>GIR</td>
                                <td> <select name="grn-reg"> <option value="0"> </option> <option value="1">✓</option> </select> </td> <td> <select name="grn-reg"> <option value="0"> </option> <option value="1">✓</option> </select> </td> <td> <select name="grn-reg"> <option value="0"> </option> <option value="1">✓</option> </select> </td> <td> <select name="grn-reg"> <option value="0"> </option> <option value="1">✓</option> </select> </td> <td> <select name="grn-reg"> <option value="0"> </option> <option value="1">✓</option> </select> </td> <td> <select name="grn-reg"> <option value="0"> </option> <option value="1">✓</option> </select> </td> <td> <select name="grn-reg"> <option value="0"> </option> <option value="1">✓</option> </select> </td> <td> <select name="grn-reg"> <option value="0"> </option> <option value="1">✓</option> </select> </td> <td> <select name="grn-reg"> <option value="0"> </option> <option value="1">✓</option> </select> </td>
                                <td></td>
                                <td> <select name="grn-reg"> <option value="0"> </option> <option value="1">✓</option> </select> </td> <td> <select name="grn-reg"> <option value="0"> </option> <option value="1">✓</option> </select> </td> <td> <select name="grn-reg"> <option value="0"> </option> <option value="1">✓</option> </select> </td> <td> <select name="grn-reg"> <option value="0"> </option> <option value="1">✓</option> </select> </td> <td> <select name="grn-reg"> <option value="0"> </option> <option value="1">✓</option> </select> </td> <td> <select name="grn-reg"> <option value="0"> </option> <option value="1">✓</option> </select> </td> <td> <select name="grn-reg"> <option value="0"> </option> <option value="1">✓</option> </select> </td> <td> <select name="grn-reg"> <option value="0"> </option> <option value="1">✓</option> </select> </td> <td> <select name="grn-reg"> <option value="0"> </option> <option value="1">✓</option> </select> </td>
                                <td colspan="2"></td> </tr>
                        </tbody>
